...
$('#copy').on('click', function () {
    ...
    if (qty1 == "") {
        alert('Qty Feld leer ist!');
    } else if (qty1 < 1) {
        alert('Qty kann nicht 0 oder negative Zahl sein');
    } else if (ins_lvl == "") {
        alert('Definieren Allgemeine Inspektionsebene!');
    } else if (spe_lvl == "") {
        alert('Definieren spezielle Inspektionsebene!');
    } else if (min == "") {
        alert('Definieren kleinere AQL!');
    } else if (maj == "") {
        alert('Definieren großen aql!');
    } else {
        $('#qty').val(qty1);
