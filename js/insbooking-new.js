    ...
    $('#Factory_Name').on('change', function(event) {
        ...
        $.ajax({
            ...
            success: function(show) {
                ...
                $('#Factory_address_local').val(show.flist_local_address);
                $('#view_state').val(show.flist_state);
                $('#view_zip_code').val(show.flist_zipcode);
...
$(document).ready(function() {
    ...
    $('#add_file').click(function() {
        $('#file_tools').before('<tr id="f' + counter + '"><td><div class="file_upload"><input name="file[]" type="file"><a onclick="delfile(' + counter + ')" title="Delete" >Delete</a> </div></td></tr>');
        counter++;
    });
});
