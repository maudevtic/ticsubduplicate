...
<head>
    <title>TIC - Order Management</title>
    <meta charset="utf-8">
    ...
    <style>
        .parallax {
            background-image: url('images/backgrounds/order-management.webp');
            height: 400px;
        }
    </style>
</head>
<body>
    <div class="site_wrapper">
        ...
        <div class="header_medium two parallax">
            <div class="container">
                <h3 class="bigtext"><?php displayText("order-management", $_SESSION["language"], "h3-1"); ?></h3>
                <h3 class="smalltext"><?php displayText("order-management", $_SESSION["language"], "h3-2"); ?></h3>
                <div style="">
        ...
        <div class="section_holder18">
            <div class="container">
                <div class="pagetitle">
                    <h3><?php displayText("order-management", $_SESSION["language"], "h3-3"); ?></h3>
                </div>
                <div class="pagenation">&nbsp;
                    <a href="index.php"><?php displayText("order-management", $_SESSION["language"], "a1"); ?></a>
                    <i>/</i>
                    <?php displayText("order-management", $_SESSION["language"], "div1"); ?>
                </div>
            </div>
        </div>
        <div class="clearfix"></div>
        <div class="section_holder20">
            <div class="container">
                <h1 class="lt_title_big"><?php displayText("order-management", $_SESSION["language"], "h1-1"); ?></h1>
                ...
                <div class="section_holder25">
                    <div class="container">
                        <div class="content_left">
                            <h1 class="uppercase margin_top4"><?php displayText("order-management", $_SESSION["language"], "h1-2"); ?></h1>
                            <p><?php displayText("order-management", $_SESSION["language"], "p1"); ?></p>
                            <br />
                            <img src="images/order-management.webp" alt="Order Management2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          " class="vw100" />
                            <div class="margin_top2"></div>
                            <div class="punchline_text_box">
                                <div class="left">
                                    <h5><?php displayText("order-management", $_SESSION["language"], "h5-1"); ?></h5>
                                </div>
                                <div class="right">
                                    <a class="knowmore_but" href="https://tic-service.company/create-account">
                                        <?php displayText("order-management", $_SESSION["language"], "a2"); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
