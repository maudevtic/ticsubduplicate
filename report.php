...
<body>
    <div class="site_wrapper">
        ...
        <div class="header_medium two parallax">
            <div class="container">
                <h3 class="bigtext"><?php displayText("online-inspection-report", $_SESSION["language"], "h3-1"); ?></h3>
                <h3 class="smalltext"><?php displayText("online-inspection-report", $_SESSION["language"], "h3-2"); ?></h3>
                <div style="">
        ...
        <div class="section_holder18">
            <div class="container">
                <div class="pagetitle">
                    <h3><?php displayText("online-inspection-report", $_SESSION["language"], "h3-3"); ?></h3>
                </div>
                <div class="pagenation">&nbsp;
                    <a href="index.php">
                        <?php displayText("online-inspection-report", $_SESSION["language"], "a1"); ?>
                    </a>
                    <i>/</i>
                    <?php displayText("online-inspection-report", $_SESSION["language"], "h3-3"); ?>
                </div>
            </div>
        </div>
        <!--end pagenation-->
        ...
        <div class="section_holder20">
            <div class="container">
                <h1 class="lt_title_big">
                    <?php displayText("online-inspection-report", $_SESSION["language"], "h1-1"); ?>
                </h1>
                ...
                <div class="section_holder25">
                    <div class="container">
                        <div class="content_left">
                            ...
                            <p>
                                <?php displayText("online-inspection-report", $_SESSION["language"], "p1"); ?>
                            </p>
                            <br />
                            <img src="images/q5.webp" alt="Online Report" class="vw100" />
                            <div class="margin_top2"></div>
                            <div class="punchline_text_box">
                                <div class="left">
                                    <h5>
                                        <?php displayText("online-inspection-report", $_SESSION["language"], "h5-1"); ?>
                                    </h5>
                                </div>
                                <div class="right">
                                    <a class="knowmore_but" href="https://tic-service.company/create-account">
                                        <?php displayText("online-inspection-report", $_SESSION["language"], "a2"); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
